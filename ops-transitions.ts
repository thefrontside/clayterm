...
export function propertyMask(name: TransitionProperty): number {
  switch (name) {
    case "x": return TP_X;
    case "y": return TP_Y;
    case "position": return TP_POSITION;
    case "width": return TP_WIDTH;
    case "height": return TP_HEIGHT;
    case "size": return TP_SIZE;
    case "bg": return TP_BG;
    case "overlay": return TP_OVERLAY;
    case "borderColor": return TP_BORDER_COLOR;
    case "borderWidth": return TP_BORDER_WIDTH;
    case "all": return TP_ALL;
  }
}
...
export function easingByte(easing: Easing): number {
  switch (easing) {
    ...
    case "easeIn": return EASING_EASE_IN;
    case "easeOut": return EASING_EASE_OUT;
